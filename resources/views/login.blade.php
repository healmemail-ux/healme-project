...
<head>
    ...
    <title>Login Akun For Amelia-VintageStore</title>
     <!-- Favicons -->
        ...
        <div class="col-md-5 offset-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- <div class="form-group">
                        <label>Telp</label>
                        <input type="telp" class="form-control" id="telp" placeholder="Masukkan telp">
                    </div> -->

                    <button class="btn btn-login btn-block btn-primary bi bi-stars">LOGIN</button>
